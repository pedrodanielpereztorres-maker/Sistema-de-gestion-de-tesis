...
# Tamaños de fuente en rem → se adaptan al DPI del sistema (Windows y Ubuntu)
FS_HEADER  = "0.78rem"   # cabeceras de columna
FS_BODY    = "0.93rem"   # texto principal de celda
FS_SMALL   = "0.83rem"   # texto secundario / badges
FS_BTN     = "0.87rem"   # texto de botones
...
def fila_estudiante(estudiante) -> rx.Component:
    ...
    inicial_cell = rx.table.cell(
        rx.center(
            rx.text(
                estudiante.get("nombre").to(str)[0],
                style={"font_size": "1rem", "font_weight": "800",
                       "color": "white", "text_transform": "uppercase"},
            ),
        ...
        rx.vstack(
            rx.hstack(
                rx.text(
                    ...
                    style={"font_size": FS_BODY, "font_weight": "700",
                           "color": "#0F172A"}
                ),
                rx.text(
            ...
            rx.text(
                ...
                style={"font_size": FS_SMALL, "color": "#64748B",
                       "font_weight": "500"}
            ),
            spacing="0", align="start",
        ),
        py="2", px="3", white_space="nowrap",
    )
    ...
    tutor_cell = rx.table.cell(
        rx.cond(
            ...
            rx.hstack(
                ...
                rx.text(
                    estudiante.get("nombre_tutor"),
                    style={"font_size": FS_BODY, "color": "#065F46",
                           "font_weight": "600"}
                ),
                spacing="1", align="center",
            ),
    ...
    empresa_cell = rx.table.cell(
        rx.cond(
            ...
            rx.button(
                ...
                variant="soft", color_scheme="indigo",
                style={
                    "border_radius": "8px",
                    "cursor": "pointer",
                    "border": "1px solid #C7D2FE",
    ...
    fecha_ini_cell = rx.table.cell(
        rx.hstack(
            ...
            rx.text(
                estudiante.get("fecha_inicio_formateada"),
                style={"font_size": FS_BODY, "color": "#334155",
                       "font_weight": "500"}
            ),
            spacing="1", align="center"
        ),
    ...
    fecha_fin_cell = rx.table.cell(
        rx.hstack(
            ...
            rx.text(
                estudiante.get("fecha_cierre_formateada"),
                style={"font_size": FS_BODY, "color": "#065F46",
                       "font_weight": "500"}
            ),
            spacing="1", align="center"
        ...
        rx.hstack(
            rx.button(
                rx.hstack(
                    ...
                    rx.text("Editar",
                            style={"font_size": FS_BTN, "font_weight": "700"}),
                    spacing="1", align="center"
                ),
                on_click=EstadoEstudiante.abrir_modal_edicion_estudiante(
                    estudiante.get("cedula")
                ),
                variant="soft",
                style={
                ...
                _hover={"background_color": "#DBEAFE",
                        "transform": "translateY(-1px)"},
            ),
            rx.button(
                rx.hstack(
                ...
                on_click=EstadoEstudiante.abrir_modal_confirmacion(
                    estudiante.get("cedula")
                ),
                variant="soft",
                style={
                ...
                _hover={"background_color": "#FEE2E2",
                        "transform": "translateY(-1px)"},
            ),
            spacing="2",
        ),
...
def tarjeta_empresa() -> rx.Component:
    def fila_dato(icono: str, etiqueta: str, valor,
                  color_icono: str = "#6366F1") -> rx.Component:
        return rx.hstack(
            rx.center(
            ...
            rx.vstack(
                rx.text(
                    ...
                    style={"font_size": "0.72rem", "font_weight": "700",
                           "color": "#64748B", "text_transform": "uppercase",
                           "letter_spacing": "0.07em"}
                ),
                rx.text(
                    rx.cond(valor, valor, "—"),
                    style={"font_size": "0.93rem", "font_weight": "600",
                           "color": "#0F172A", "word_break": "break-word"}
                ),
        ...
        rx.box(
            ...
            rx.box(
                rx.vstack(
                    ...
                    rx.box(
                        rx.text(
                            rx.cond(EstadoEstudiante.nombre_empresa,
                    ...
                    rx.vstack(
                        fila_dato("map-pin", "Dirección",
                                  EstadoEstudiante.direccion_empresa, "#0EA5E9"),
                        fila_dato("mail", "Correo Electrónico",
                                  EstadoEstudiante.correo_empresa, "#6366F1"),
                        fila_dato("phone", "Teléfono",
                                  EstadoEstudiante.telefono_empresa, "#10B981"),
                        fila_dato("user-check", "Tutor / Contacto",
                                  EstadoEstudiante.tutor_empresa, "#F59E0B"),
                        spacing="4", width="100%",
                    ),
                    rx.button(
                        rx.hstack(
    ...
    return rx.vstack(
        ...
        rx.box(
            rx.table.root(
                ...
                rx.table.body(
                    rx.foreach(EstadoEstudiante.estudiantes_filtrados,
                               fila_estudiante)
                ),
                variant="ghost",
                width="100%",
                # Font base para toda la tabla desde rem
                style={"font_size": FS_BODY},
            ),
            width="100%",
            overflow_x="auto",
            background="white",
        ...
        rx.box(
            rx.hstack(
                rx.button(
                    ...
                    style={"border": f"1px solid {COLOR_BORDE}",
                           "border_radius": "9px"},
                    _hover={"background_color": "#E2E8F0"},
                ),
                rx.hstack(
