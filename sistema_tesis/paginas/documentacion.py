...
def tarjeta_documento(doc: Documento) -> rx.Component:
    ...
    nombre_icono = rx.cond(
        tipo.contains("pdf"), "file-text",
        rx.cond(
            tipo.contains("doc"), "file-type-2",
            rx.cond(
                tipo.contains("xls"), "file-spreadsheet",
                "file"
            )
        )
    )
    ...
    color_icono = rx.cond(
        tipo.contains("pdf"), COLOR_ICONO_PDF,
        rx.cond(
            tipo.contains("doc"), COLOR_ICONO_WORD,
            rx.cond(
                tipo.contains("xls"), COLOR_ICONO_EXCEL,
                COLOR_ICONO_GENERICO
            )
        )
    )
    ...
    return rx.card(
        rx.flex(
            rx.hstack(
                ...
                rx.vstack(
                    rx.text(doc.titulo, weight="bold",
                            size="3", color="#0F172A"),
                    rx.text(doc.descripcion, size="2",
                            color="#1E293B", no_of_lines=2),
                    rx.hstack(
                        rx.badge(doc.tipo.upper(), variant="soft",
                                 color_scheme="gray", radius="full", size="1",
                                 style={
                        ...
                        rx.text(f"• {doc.tamano}", size="1", color="#475569"),
                        rx.text(f"• {doc.fecha_subida}",
                                size="1", color="#475569"),
            ...
            rx.hstack(
                ...
                rx.icon_button(
                    ...
                    on_click=rx.cond(
                        doc.url != "",
                        rx.download(
                            url=doc.url, filename=f"{doc.titulo}.{doc.tipo}"),
                        None
                    ),
                    variant="solid",
                    color_scheme="blue",
                ...
                rx.cond(
                    ...
                    rx.hstack(
                        rx.icon_button(
                            ...
                            on_click=lambda: EstadoDocumento.preparar_edicion(
                                doc),
                        ...
                        rx.icon_button(
                            ...
                            on_click=lambda: EstadoDocumento.eliminar_documento(
                                doc.id),
                            variant="solid", color_scheme="red",
                            size="2", radius="full", cursor="pointer",
                            title="Eliminar"
                        ),
                        spacing="2"
        ...
        _hover={"border_color": "#6366F1", "transform": "translateY(-2px)",
        ...
        rx.box(
            rx.vstack(
                rx.hstack(
                    ...
                    rx.text("Publicar Nuevo Documento",
                            weight="bold", color="#4338CA"),
                    align="center", spacing="2", margin_bottom="2"
                ),

                rx.grid(
                    rx.vstack(
                        rx.text("Detalles del archivo", size="2",
                        ...
                        rx.text_area(
                            ...
                            variant="classic",
                            radius="large", width="100%", resize="vertical",
                            style={
                                "background_color": "white",
                    ...
                    rx.cond(
                        ...
                        rx.center(
                            rx.vstack(
                                rx.icon("file-check", size=40,
                                        color="#4F46E5"),
                                rx.foreach(
                                    rx.selected_files("upload_docs"),
                                    lambda f: rx.text(
                                        f, weight="bold", color="#1E293B", text_align="center")
                                ),
                                rx.button(
                                    "Cambiar archivo",
                                ...
                                spacing="3", align="center", padding="30px",
                                border="2px solid #4F46E5", border_radius="12px",
                                background="rgba(79,70,229,0.05)", width="100%", height="100%"
                            ),
                        ...
                        rx.upload(
                            rx.vstack(
                                ...
                                rx.text("Arrastra archivos aquí o haz clic",
                                        color="#334155", weight="medium"),
                                rx.text("Soporta PDF, Word, Excel",
                                        size="1", color="#475569"),
                                align="center", spacing="2"
                            ),
                            id="upload_docs",
                            border="2px dashed #CBD5E1",
                            padding="30px", border_radius="12px",
                ...
                rx.hstack(
                    ...
                    rx.button(
                        rx.hstack(rx.icon("send", size=16),
                                  rx.text("Publicar Documento")),
                        on_click=lambda: EstadoDocumento.publicar_documento(
                            rx.upload_files("upload_docs")),
                        size="3", variant="solid", color_scheme="indigo", radius="large",
    ...
    return rx.cond(
        ...
        rx.box(
            rx.box(
                ...
                background="rgba(10,10,30,0.5)", backdrop_filter="blur(2px)",
                z_index="100", on_click=EstadoDocumento.cancelar_edicion
            ),
            rx.box(
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.text("Editar Documento", size="5",
                                weight="bold", color="#1E293B"),
                        rx.spacer(),
                        rx.icon_button(
                            "x", on_click=EstadoDocumento.cancelar_edicion, variant="ghost", color_scheme="gray"
                        ),
                    ...
                    rx.hstack(
                        rx.button("Cancelar", on_click=EstadoDocumento.cancelar_edicion,
                                  variant="soft", color_scheme="gray"),
                        rx.button("Guardar Cambios", on_click=EstadoDocumento.guardar_edicion,
                                  variant="solid", color_scheme="indigo"),
                        spacing="3", justify="end", width="100%", margin_top="6"
                    ),
                    width="100%"
                ),
                padding="24px",
...
def contenido_documentacion() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.heading("Archivos Disponibles",
                       size="6", color="#1E293B"),
            rx.spacer(),
            rx.text(
                f"{EstadoDocumento.documentos_filtrados.length()} documentos",
                size="2", color="#475569"
            ),
            width="100%", align="center", margin_bottom="4"
        ),
        rx.cond(
            ...
            rx.vstack(
                rx.foreach(
                    EstadoDocumento.documentos_filtrados, tarjeta_documento),
                spacing="4", width="100%"
            ),
            rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.text(
                        "Sin resultados para \"" + EstadoDocumento.busqueda_documento + "\"",
                        color="#475569",
                        font_weight="600",
                    ),
                    rx.text(
                ...
                rx.center(
                    rx.text("No hay documentos publicados aún.",
                            color="#475569"),
                    padding="20px"
                )
            )
        ...
        width="100%", padding=["16px", "20px", "24px", "24px"],
        max_width="1200px", spacing="5",
...
def pagina_documentacion() -> rx.Component:
    return rx.theme(
        rx.cond(
            ...
            rx.center(rx.spinner(), width="100vw", height="100vh",
