        ...
        rx.box(
            ...
            rx.box(
                rx.vstack(
                    ...
                    rx.hstack(
                        rx.center(
                            rx.icon("triangle-alert", size=22, color="white", stroke_width=2.5),
                        ...
                        rx.vstack(
                            rx.text("Desactivar Estudiante", size="4",
                                    weight="bold", color="#0F172A"),
                            rx.text("Esta acción es reversible desde el panel de mantenimiento.",
                                    size="1", color="#B91C1C", font_weight="600"),
                    ...
                    rx.text(
                        ...
                        size="2", color="#334155", line_height="1.6",
                    ),
                    # Campo contraseña
                    rx.vstack(
                        rx.text("Contraseña de Administrador", size="2",
                    ...
                    rx.hstack(
                        ...
                        rx.button(
                            ...
                            _hover={"box_shadow": "0 6px 18px rgba(239,68,68,0.30)",
